...
def get_cpatured_header(printHeader=False,N=1,buf=[]):
    ...
    for i in range(number_of_frames):
        ...
        #decisionRe6 = buf[idx+20]*(1 << 0) + buf[idx+21]*(1 << 8) + buf[idx+22]*(1 << 16) + buf[idx+23]*(1 << 24)
        #decisionIm6 = buf[idx+24]*(1 << 0) + buf[idx+25]*(1 << 8) + buf[idx+26]*(1 << 16) + buf[idx+27]*(1 << 24)
        #decisionRe7 = buf[idx+28]*(1 << 0) + buf[idx+29]*(1 << 8) + buf[idx+30]*(1 << 16) + buf[idx+31]*(1 << 24)
        #decisionIm7 = buf[idx+32]*(1 << 0) + buf[idx+33]*(1 << 8) + buf[idx+34]*(1 << 16) + buf[idx+35]*(1 << 24)
        #decisionRe8 = buf[idx+36]*(1 << 0) + buf[idx+37]*(1 << 8) + buf[idx+38]*(1 << 16) + buf[idx+39]*(1 << 24)
        #decisionIm8 = buf[idx+40]*(1 << 0) + buf[idx+41]*(1 << 8) + buf[idx+42]*(1 << 16) + buf[idx+43]*(1 << 24)
        #decisionRe9 = buf[idx+44]*(1 << 0) + buf[idx+45]*(1 << 8) + buf[idx+46]*(1 << 16) + buf[idx+47]*(1 << 24)
        #decisionIm9 = buf[idx+48]*(1 << 0) + buf[idx+49]*(1 << 8) + buf[idx+50]*(1 << 16) + buf[idx+51]*(1 << 24)
        #decisionRe10 = buf[idx+52]*(1 << 0) + buf[idx+53]*(1 << 8) + buf[idx+54]*(1 << 16) + buf[idx+55]*(1 << 24)
        #decisionIm10 = buf[idx+56]*(1 << 0) + buf[idx+57]*(1 << 8) + buf[idx+58]*(1 << 16) + buf[idx+59]*(1 << 24)
...
def pack_kernel_data(ki,kq,EXPORT=False,PATH=''):
    ...
    #print('fout_q = ',(fout_q[0] << 16))
	
    kernel_data = np.zeros(L*4, np.uint32)
    for i in range(L*4):
        kernel_data[i] = out_q[i]*(1 << 16) + out_i[i]
        #kernel_data[i] = (fout_q[i] << 16) + fout_i[i]
